...
exports.onRunMigrations = onRunMigrations;
const sequelize_1 = require("sequelize");
const umzug_1 = require("umzug");
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config();
function getSequelize(dbName, dbUser, dbPassword, dbHost, dbPort) {
...
async function runMigrations(umzug, sequelize) {
    try {
        await umzug.up();
...
async function onRunMigrations() {
    ...
    try {
        ...
        const sequelize = getSequelize(MYSQL_DB, MYSQL_USER, MYSQL_PASSWORD, MYSQL_HOST, dbPort);
